...
a.act{
background: linear-gradient(to right, #555 0%, red 100%);
color: black;
border-radius:10px;
}
...
<div class="sidebar" ><b>
  ...
  <a href="query.php"   <?php if($active=='query') echo "class='act'"; ?>><span class="glyphicon glyphicon-check"></span>&nbsp&nbspCheck Contact us Query</a>
  <a href="donor_history.php"   <?php if($active=='list') echo "class='act'"; ?>><span class="glyphicon glyphicon-list"></span>&nbsp&nbsp Donor history</a>
