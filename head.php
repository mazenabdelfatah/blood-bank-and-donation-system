...
<body>
  <div class="header">
    ...
    <a href="index.php" class="logo" style="font-size: 20px; padding-left:10px;" <?php if($active=='home') echo "class='logo2'"; ?>>Home </a>
    ...
    <a href="why_donate_blood.php"  <?php if($active=='why') echo "class='act'"; ?>>Why Donate Blood</a>
      ...
      <a href="nearest.php"  <?php if($active=='nearest') echo "class='act'"; ?> >Nearest Blood Banks</a>
