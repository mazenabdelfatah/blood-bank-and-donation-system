  ...
  <div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="image\img8.jpg" alt="image\img8.jpg" width="100%" height="500">
      </div>
      <div class="carousel-item">
        <img src="image\img10.jpg" alt="image\img10.jpg" width="100%" height="500">
      </div>
...
<br>
        <h1 style="text-align:center;font-size:40px;">BloodBank & Donor Management System</h1>
<br>
        <div class="row">
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header card bg-info text-white" >The need for blood</h4>
                        ...
                        <p class="card-body overflow-auto" style="padding-left:2%;height:120px;text-align:left; block-size:fit-content;">
                          <?php
                            include 'conn.php';
          ...
          <?php
           ...
           ?>
            ...
            <div class="card" style="width:300px">
                <img class="card-img-top" src="image\img2.jpg" alt="Card image" style="width:100%;height:300px">
                <div class="card-body">
...
<br>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <img class="img-fluid rounded" src="image\img7.jpg" alt="" >
            </div>
        </div>
